...
def get_vit_tiny_patch16_224(cfg, no_head=True, **kwargs): # with parameters of 8M
    patch_size = 16
    vit = VisionTransformer(img_size=cfg.DATA.TRAIN_CROP_SIZE, num_classes=cfg.MODEL.NUM_CLASSES,
...
def build_vit_base_patch16_224():
    ...
    opt.cfg_file = "../OVFM/TransUNet/networks/vit/configs/Kinetics/TimeSformer_divST_8x32_224.yaml"
...
def build_vit_small_patch16_224():
    from .utils.parser import parse_args, load_config
    ...
    config = load_config(opt)
    model = get_vit_small_patch16_224(cfg=config)
