    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            frames = decode(
                ...
                num_frames=self.cfg.DATA.NUM_FRAMES, #8
                clip_idx=temporal_sample_index, #0
                num_clips=self.cfg.TEST.NUM_ENSEMBLE_VIEWS, #1
                video_meta=self._video_meta[index], #{}
                target_fps=self.cfg.DATA.TARGET_FPS, # 30
                backend=self.cfg.DATA.DECODING_BACKEND, # "pyav"
                max_spatial_scale=min_scale, #224
            )
...
if __name__ == '__main__':
    ...
    args = parse_args()
    args.cfg_file = "./Endo_FM/Endo-FM-main/models/configs/Kinetics/TimeSformer_divST_8x32_224.yaml"
    config = load_config(args)
    config.DATA.PATH_TO_DATA_DIR = "./Endo_FM/Endo-FM-main/data/downstream/PolypDiag/splits"
    config.DATA.PATH_PREFIX = "./Endo_FM/Endo-FM-main/data/downstream/PolypDiag/videos"
